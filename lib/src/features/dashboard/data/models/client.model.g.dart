...
class _DashboardClient implements DashboardClient {
  ...
  @override
  Future<List<Book?>> getTrendingBook(String jwttoken) async {
    ...
    var value = _result.data!
        .map((dynamic i) =>
            i == null ? null : Book.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }

  @override
  Future<List<Book?>> getEditorchoice(String jwttoken) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'authorization': jwttoken};
    _headers.removeWhere((k, v) => v == null);
